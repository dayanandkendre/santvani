...
// =========================================================
// 🔥 FIREBASE CUSTOM PREMIUM COMMENTS SYSTEM (EXCLUSIONS LIST)
// =========================================================

(function () {
    var currentPath = window.location.pathname.toLowerCase();
    
    // १. ज्या पेजेसवर कमेंट बॉक्स नको आहे त्यांची अचूक यादी
    var excludedPages = [
        "index.html",
        "about.html",
        "contact.html",
    ...
    // २. चेक करणे – जर रूट असेल किंवा वरीलपैकी कोणतेही पेज असेल तर कमेंट बॉक्स ब्लॉक राहील
